...
<body>
    ...
    <div class="login">
        ...
        <div id="left_box">
            ...
            <form action="/Suman_Mondal(Project)/login.php" method="post">
                    <input type="text" name="mobile" id="mobile" class="in" placeholder="Mobile No.">
                    <br><br>
                    <input type="password" name="password" id="password" class="in" placeholder="Password">
                    <button type = "submit" name="login" class="click">Sigin</button>
            </form>
            <div class="forgot_password">
                <button>Forgot Password ?</button>
            </div>
            <p class="errorMsg">*Wrong Mobile Number or Password, Try Again</p>
    ...
    <div class="signup">
        ...
        <div class="click2">
            <a href="/Suman_Mondal(Project)/personal_details.php">
