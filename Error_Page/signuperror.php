...
<body>
    ...
    <div class="box">
        ...
        <!--Form-->
        <form action="/Suman_Mondal(Project)/dbm.php" method="post" enctype="multipart/form-data">

            <img src="/Suman_Mondal(Project)/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg" alt="">
            <br><input type="file" name="image" class="photo" required>

            <div class="section1">
                Mobile Number<br><input type="text" class="in" name="mobile" placeholder="Enter Mobile Number" required>
                <div class="errorMsg">
                    <p>*Mobile Number is already exits, refresh and try with another number</p>
                </div>
                <br><br>
        ...
        <!--Back Button-->
        <button>
            <a href="/Suman_Mondal(Project)/personal_details.php">Refresh</a>
        </button>
    </div>
